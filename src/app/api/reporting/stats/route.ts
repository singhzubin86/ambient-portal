 ...
 *
 * Forwards query params (start_date, end_date) to the upstream API.
 * Returns daily stats rows + summary for the publisher's reporting page.
 */
...
export async function GET(req: NextRequest) {
  ...
  const upstream = `${API_URL}/v1/portal/publishers/me/stats${qs ? `?${qs}` : ""}`;
